...
const mw = require('../../../src/services/provider-delete-notification-processor/src/profile-update-mw')(
  repoStub
);
...
describe('provider-delete-notification-processor profile-update-mw unit-tests', () => {
  afterEach(() => {
    next.resetHistory();
