...
- **GET /profile/:profileId**: To enable a specific profile to be retrieved
...
- **DELETE /profile/:profileId**: To enable a specific profile to be delete
...
- **service specific express MW**: Contains express MW which is dedicated to the create profile service
  ...
  - **success-mw**: Triggered as the last MW in the chain and if triggered means that everything was fine and the profile was successfully created. This MW just send and HTTP 201 status code back to the consumer.
...
- **service specific express MW**: Contains express MW which is dedicated to the create profile service
  ...
  - **success-mw**: Triggered as the last MW in the chain and if triggered means that everything was fine and the profile was successfully updated. This MW just sends and HTTP 200 status code back to the consumer.
